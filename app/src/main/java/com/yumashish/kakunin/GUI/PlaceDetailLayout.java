...
public class PlaceDetailLayout {
    ...
    public PlaceDetailLayout(GOGAMapActivity context, PlaceJSON place, ViewGroup parent) {
        ...
        title = (TextView) frame.findViewById(R.id.gdiw_name);
        detail = (TextView) frame.findViewById(R.id.gdiw_detail);
        rating = (RatingBar) frame.findViewById(R.id.pdiw_rating);
        loading = (ProgressBar) frame.findViewById(R.id.gdiw_progress_bar);
        progressBarFrame = (LinearLayout) frame.findViewById(R.id.gdiw_progress_frame);
