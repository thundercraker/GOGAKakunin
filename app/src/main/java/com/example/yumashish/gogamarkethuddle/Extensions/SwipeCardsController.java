...
import com.example.yumashish.gogamarkethuddle.Search.ImageLoadedHandler;
import com.example.yumashish.gogamarkethuddle.Search.LoadImageTask;
...
public class SwipeCardsController implements View.OnTouchListener {
    ...
    public static class BasicTapCard implements TapCardInterface {
        protected int mId;
        protected String mName;
        protected String mLine1;
        protected LoadImageTask mPicRetreiver;
        protected String mLine2;
        protected Bitmap image;

        public LoadImageTask getPictureRetreiver() { return mPicRetreiver; }
        ...
        public int getLayoutId() {
            return R.layout.swippable_card;
        }
        ...
        @Override
        public LoadImageTask modifyTapCardView(final View card) {
            final ImageView profile = (ImageView) card.findViewById(R.id.imageView);
            ...
            LoadImageTask loader = getPictureRetreiver();
            loader.SetImageLoadedHandler(new ImageLoadedHandler() {
                @Override
            ...
            data1.setText(getLine1());
            data2.setText(getLine2());
            return loader;
        }

        public BasicTapCard() { mId = ID_UNIQUE++; }

        public BasicTapCard(LoadImageTask drawableRetreiver, String name, String line1, String line2)
        {
            mId = ID_UNIQUE++;
            mPicRetreiver = drawableRetreiver;
            mName = name;
            mLine1 = line1;
            mLine2 = line2;
        }
